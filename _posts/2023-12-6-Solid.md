...
##### ***Interface Segregation Principle - ISP ( Arayüz Ayrım Prensibi )***
Bir sınıfa ihtiyaç duymadığı metotlara sahip bir arayüz uygulanmamalıdır. Bu prensip, bir sınıfa yalnızca ihtiyaç duyduğu metotları içeren küçük arayüzleri uygulanması önerir.
